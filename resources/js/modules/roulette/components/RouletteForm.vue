<template>
    <section id="roulette-form">
        <el-form
            ...
            <el-form-item label="Roulette Name" prop="name" :error="errors.get('name')">
                <el-input
                    v-model="form.name"
                    @change="errors.clear('name')"
                    suffix-icon="el-icon-edit">
                </el-input>
            </el-form-item><el-form-item label="Canonical" prop="name_canonical" :error="errors.get('name_canonical')">
            <el-input
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? rouletteApi.update : rouletteApi.create
