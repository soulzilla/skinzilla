<template>
    <section id="feedback-form">
        <el-form
            ...
            <el-form-item label="Feedback Name" prop="name" :error="errors.get('name')">
                <el-input
                    v-model="form.name"
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    name: [
                        {required: true, message: 'feedback name is required'},
                    ],
                },
            }
        },
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? feedbackApi.update : feedbackApi.create
