<template>
    <section id="user-form">
        <el-form
            ...
            <el-form-item label="User Name" prop="name" :error="errors.get('name')">
                <el-input
                    v-model="form.name"
            ...
            <el-form-item label="Admin" prop="is_admin" :error="errors.get('is_admin')">
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? userApi.update : userApi.create
