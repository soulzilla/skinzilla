<template>
    <section id="skin">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Skin', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="skins-dialog">
            <SkinForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {SKIN_FETCH, SKIN_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['skins', 'skinsMeta', 'skinsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([SKIN_FETCH]),
            ...mapMutations([SKIN_OBTAIN]),
            ...
            fetchData() {
                ...
                this[SKIN_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Skin';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Skin';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the skin. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    skinApi.delete(row.id).then((response) => {
                        this.$message({
