<template>
    <section id="video">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Video', params: {id: scope.row.id}}">
                        <span class="el-link--inner item_name">{{ scope.row.url }}</span>
                    </router-link>
                </template>
            </el-table-column>
        ...
        <el-dialog
            ...
            class="videos-dialog">
            <VideoForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {VIDEO_FETCH, VIDEO_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['videos', 'videosMeta', 'videosLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([VIDEO_FETCH]),
            ...mapMutations([VIDEO_OBTAIN]),
            ...
            fetchData() {
                ...
                this[VIDEO_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Video';
                this.formData = {};
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the video. Continue?', 'Warning', {
                    ...
                    videoApi.delete(row.id).then((response) => {
                        this.$message({
