<template>
    <section id="review">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Review', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            <ReviewForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {REVIEW_FETCH, REVIEW_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['reviews', 'reviewsMeta', 'reviewsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([REVIEW_FETCH]),
            ...mapMutations([REVIEW_OBTAIN]),
            ...
            fetchData() {
                ...
                this[REVIEW_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Review';
                this.formData = {};
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the review. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    reviewApi.delete(row.id).then((response) => {
                        this.$message({
