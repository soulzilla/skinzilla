<template>
    <section id="banner">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Title" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Banner', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="banners-dialog">
            <BannerForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {BANNER_FETCH, BANNER_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['banners', 'bannersMeta', 'bannersLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([BANNER_FETCH]),
            ...mapMutations([BANNER_OBTAIN]),
            ...
            fetchData() {
                ...
                this[BANNER_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Banner';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Banner';
            ...
            handleDelete(row) {
                this.$confirm('This will permanently delete the banner. Continue?', 'Warning', {
                    ...
                    bannerApi.delete(row.id).then((response) => {
                        this.$message({
