<template>
    <section id="comment-form">
        <el-form
            ...
            <el-form-item label="Reason" prop="block_reason" :error="errors.get('block_reason')">
                <el-input
                    v-model="form.block_reason"
                    @change="errors.clear('block_reason')"
                    suffix-icon="el-icon-edit">
                </el-input>
            </el-form-item>
            <el-form-item label="Blocked" prop="blocked" :error="errors.get('blocked')">
                <el-checkbox v-model="form.blocked">
                </el-checkbox>
            </el-form-item>
        </el-form>
    ...
    export default {
        ...
        data() {
            return {
                ...
                rules: {
                    block_reason: [
                        {required: true, message: 'comment block_reason is required'},
                    ],
                },
            }
        },
            ...
            saveSubmit() {
                this.$refs['form'].validate((valid) => {
                    if (valid) {
                        ...
                        this.errors.clear()
                        let action = this.form.id ? commentApi.update : commentApi.create
