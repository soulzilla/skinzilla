<template>
    <section id="market">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Market', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            <MarketForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {MARKET_FETCH, MARKET_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['markets', 'marketsMeta', 'marketsLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([MARKET_FETCH]),
            ...mapMutations([MARKET_OBTAIN]),
            ...
            fetchData() {
                ...
                this[MARKET_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Market';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Market';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the market. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    marketApi.delete(row.id).then((response) => {
                        this.$message({
