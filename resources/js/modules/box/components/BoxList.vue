<template>
    <section id="box">
        ...
        <el-table
            ...
            <el-table-column prop="name" label="Name" min-width="200" sortable>
                <template slot-scope="scope">
                    <router-link class="el-link el-link--default ellipsis-form" :to="{name: 'Show Box', params: {id: scope.row.id}}">
        ...
        <el-dialog
            ...
            class="boxes-dialog">
            <BoxForm :initialForm="formData" @saved="saved" @cancel="formVisible = false" />
        </el-dialog>
    </section>
</template>
...
<script>
    ...
    import {BOX_FETCH, BOX_OBTAIN} from "../store/types";
    ...
    export default {
        ...
        computed: {
            ...mapGetters(['boxes', 'boxesMeta', 'boxesLoading']),
        },
        created() {
            this.fetchData()
        },
        ...
        methods: {
            ...mapActions([BOX_FETCH]),
            ...mapMutations([BOX_OBTAIN]),
            ...
            fetchData() {
                ...
                this[BOX_FETCH](params)
            },
            handleAdd() {
                this.formTitle = 'New Box';
                this.formData = {};
                this.formVisible = true;
            },
            handleEdit(row) {
                this.formTitle = 'Edit Box';
                this.formData = Object.assign({}, row);
                this.formVisible = true;
            },
            handleDelete(row) {
                this.$confirm('This will permanently delete the box. Continue?', 'Warning', {
                    type: 'warning'
                }).then(() => {
                    boxApi.delete(row.id).then((response) => {
                        this.$message({
