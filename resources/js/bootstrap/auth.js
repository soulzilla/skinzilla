...
Vue.use(VueAuth, {
    ...
    loginData:      { url: process.env.MIX_API_ENDPOINT + 'auth/login', redirect: '/' },
    logoutData:     { url: process.env.MIX_API_ENDPOINT + 'auth/logout', redirect: '/', makeRequest: true },
    registerData:   { url: process.env.MIX_API_ENDPOINT + 'auth/register', method: 'POST', redirect: '/' },
